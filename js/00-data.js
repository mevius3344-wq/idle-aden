...
const GAME_VERSION = 'v3.8.152';   // 🏷️ 版本號：末段 0~99 線性遞增，達 100 進位（中位 +1、末段歸 0）
    ...
    towns: {
		...
		"town_ivory_tower": {
            ...
            npcs: [
                ...
                { id: "npc_bian", n: "碧恩", title: "三詞強化", type: "bless", d: "屬性強化師碧恩：四屬性卷軸賦予屬性、古代卷軸賦予遠古；武器／盔甲／飾品祝福卷軸可附魔祝福或隨機調整詞條（成功率 7%）。" },
